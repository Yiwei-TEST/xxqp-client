...
var SDHCardRecordLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        var bg = new cc.Scale9Sprite("res/res_sdh/image_diban.png");
        ...
        var titleImg = new cc.Sprite("res/res_sdh/image_biaoti.png");
        titleImg.setPosition(cc.winSize.width/2,bg.y + bg.height/2 + 45);
        this.addChild(titleImg);

        var imgtopbg = new cc.Scale9Sprite("res/res_sdh/image_benjiadi.png");
        ...
        var imgleftbg = new cc.Scale9Sprite("res/res_sdh/image_zuobiandi.png");
        ...
        for(var i = 0;i<iconArr.length;++i){
            var spr = new cc.Sprite("res/res_sdh/" + iconArr[i]);
            spr.setPosition(70,bg.height/2 + ((renshu - 1)/2 - i)*172 + 6);
            bg.addChild(spr,2);
        }

        this.icon_zhuang = new cc.Sprite("res/res_sdh/iamge_zhuang.png");
