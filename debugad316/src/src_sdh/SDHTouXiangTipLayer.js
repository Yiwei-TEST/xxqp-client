...
var SDHTouXiangTipLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        this.btn_agree = new ccui.Button("res/res_sdh/tongyi.png","res/res_sdh/tongyi.png","");
        ...
        this.btn_refuse = new ccui.Button("res/res_sdh/jujue.png","res/res_sdh/jujue.png","");
