    ...
    initData:function(direct,mPanel,oPanel,banker,isMoPai){
        ...
        if(!this.oPanel.getChildByName("chupaibeijing")) {
            ...
            if (PHZRoomModel.is2Ren() && direct == 2 || PHZRoomModel.is3Ren() && direct == 3) {
                chupaibeijing = new cc.Scale9Sprite("res/res_phz/xxeqs/chupaibeijing2.png", null, cc.rect(50, 30, 7, 7));
                chupaibeijing.setPosition(158, 34)
            } else {
                chupaibeijing = new cc.Scale9Sprite("res/res_phz/xxeqs/chupaibeijing1.png", null, cc.rect(50, 30, 7, 7));
                chupaibeijing.setPosition(175, 34)
            }
            chupaibeijing.width = 335
