var DYBPRoom = BaseLayer.extend({ //BaseLayer BaseRoom
    ...
    selfRender:function(){
        ...
        this.Label_info.setPosition(this.Label_info.x - 200,this.Label_info.y + 22);
        this.Label_info.ignoreContentAdaptWithSize(false);
        this.Label_info.setSize(500, 300);
    ...
    updateBgColor:function(){
        ...
        if (PHZSetModel.zmbj == 1){
            ...
            if (PHZRoomModel.wanfa == GameTypeEunmZP.DYBP){
                gameTypeUrl = "res/res_phz/wanfaImg/gametype3_dybp.png";
            }
