...
//特殊处理大于11个吃选择的情况
    ...
    updateBgColor:function(){
        ...
        var wanfaUrl = "";
        if (PHZRoomModel.wanfa == GameTypeEunmZP.NXGHZ) {
            gameTypeUrl = "res/res_phz/wanfaImg/gametype1_nxghz.png";
        }else if (PHZRoomModel.wanfa == GameTypeEunmZP.YYWHZ){
            gameTypeUrl = "res/res_phz/wanfaImg/gametype1_yywhz.png";
        }else{
        ...
        if (PHZSetModel.zmbj == 1){
            ...
            if (PHZRoomModel.wanfa == GameTypeEunmZP.NXGHZ){
                gameTypeUrl = "res/res_phz/wanfaImg/gametype2_nxghz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.YYWHZ){
                gameTypeUrl = "res/res_phz/wanfaImg/gametype2_yywhz.png";
            }
            ...
            if (PHZRoomModel.wanfa == GameTypeEunmZP.NXGHZ){
                gameTypeUrl = "res/res_phz/wanfaImg/gametype3_nxghz.png";
            }else if (PHZRoomModel.wanfa == GameTypeEunmZP.YYWHZ){
                gameTypeUrl = "res/res_phz/wanfaImg/gametype3_yywhz.png";
            }
