...
var NSBSmallResultLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        this.btn_jxyx = new ccui.Button("res/res_nsb/btn_jixu.png","res/res_nsb/btn_jixu.png");
    ...
    addTitleImg:function(type){
        var img = "res/res_nsb/biaoti.png";
        if(type < 0){
            img = "res/res_nsb/biaoti1.png";
        }
...
var NSBSmallResultItem = cc.Node.extend({
    ...
    initNode:function(){
        this.itemBg = new cc.Sprite("res/res_nsb/lan_di.png");
    ...
    setItemData:function(data){
        ...
        var bgImg = "res/res_nsb/lan_di.png";
        if(data.ext[4] == 2){
            bgImg = "res/res_nsb/hong_di.png";
        }
        this.itemBg.initWithFile(bgImg);

        if(data.ext[3] > 0){
            var youImg = "res/res_nsb/you_" + data.ext[3] + "_icon.png";
