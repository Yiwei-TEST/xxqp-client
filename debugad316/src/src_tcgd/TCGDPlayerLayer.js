    ...
    onFastChat:function(event){
        ...
        if(id < 0){
            ...
            if(id >= 200){
                ...
                var realPath = "res/res_tcgd/sound/"+ path + "fixMsg/fix_msg_" + (id-1) +".mp3";
...
var TCGDPlayerNode = cc.Node.extend({
    ...
    setYouSpr:function(data){
        ...
        if(data.ext[7] > 0){
            this.youSpr.initWithFile("res/res_tcgd/you_" + data.ext[7] + "_icon.png");
    ...
    setTipSpr:function(type){
        if(type == 1){
            ...
            this.tipSpr.initWithFile("res/res_tcgd/duzhan.png");
        }else if(type == 2){
            this.tipSpr.setVisible(true);
            this.tipSpr.initWithFile("res/res_tcgd/team_icon.png");
        }else{
    ...
    initNode:function(){
        ...
        this.infobg = new cc.Sprite("res/res_tcgd/xinxi_di.png");
        this.addChild(this.infobg);

        this.fenbg1 = new cc.Sprite("res/res_tcgd/fenshu_di.png");
        this.addChild(this.fenbg1);

        var tip1 = new cc.Sprite("res/res_tcgd/fen.png");
        ...
        this.image_coin = new cc.Sprite("res/res_tcgd/img_jinbi.png");
        ...
        this.icon_tuoguan = new cc.Sprite("res/res_tcgd/tuoguan.png");
        this.addChild(this.icon_tuoguan,2);

        this.icon_ip_same = new cc.Sprite("res/res_tcgd/ipsame.png");
        this.icon_ip_same.setScale(0.9);
        this.addChild(this.icon_ip_same,2);

        this.spr_out_line = new cc.Sprite("res/res_tcgd/img_zl.png");
        this.addChild(this.spr_out_line,3);

        this.icon_zhunbei = new cc.Sprite("res/res_tcgd/zhunbei.png");
        this.addChild(this.icon_zhunbei);

        this.yybg = new cc.Sprite("res/res_tcgd/img_yybg.png");
        this.yybg.setAnchorPoint(1,0.5);
        this.yybg.setVisible(false);
        this.addChild(this.yybg);

        this.yyts = new cc.Sprite("res/res_tcgd/img_yyts.png");
        ...
        this.warningSpr = new cc.Sprite("res/res_tcgd/warning.png");
        this.addChild(this.warningSpr);

        this.tipSpr = new cc.Sprite("res/res_tcgd/duzhan.png");
        this.addChild(this.tipSpr,3);

        this.paiBei = new cc.Sprite("res/res_tcgd/paibei.png");
        ...
        this.baoWangBg = new cc.Scale9Sprite("res/res_tcgd/jiugonga1.png");
        ...
        this.yaobuqiSpr = new cc.Sprite("res/res_tcgd/yaobuqi.png");
        this.yaobuqiSpr.setScale(0.8);
        this.addChild(this.yaobuqiSpr);

        this.icon_zhuang = new cc.Sprite("res/res_tcgd/zhuang.png");
        this.icon_zhuang.setScale(0.8);
        this.addChild(this.icon_zhuang,2);

        this.icon_zhuang.setPosition(-53,-45);

        this.mingpai_bg = new cc.Scale9Sprite("res/res_tcgd/baofu_bg.png");
    ...
    setPosWithIdx:function(idx){
        ...
        switch (idx) {
            ...
            case 1:
                ...
                this.label_sai.setPosition(0,-195);
            ...
            case 2:
                ...
                this.label_sai.setPosition(170,-45);
