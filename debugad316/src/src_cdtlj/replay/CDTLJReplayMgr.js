...
var CDTLJReplayMgr = {
    ...
    handleReplayData:function(hfData){
        ...
        this.msgArr.push({type:CDTLJTabelType.CreateTable,data:data});
    ...
    handStepMsg:function(stepsData){
        ...
        for(var idx = 0;idx<stepsData.length;++idx){
            ...
            if(step.action == 1){//抢庄/反主
                msg.type = CDTLJTabelType.JiaoFen;
                msg.data = {};
                var params = [];
                params[0] = 0;
                ...
                msg.type = CDTLJTabelType.XuanZhu;
                msg.data = {};
                ...
                msg.type = CDTLJTabelType.PlayCard;
                msg.data = {};
                msg.data.cardType = 0;
                ...
                for(var i = 0;i<table.players.length;++i){
                    ...
                    if(p.seat == msg.data.seat){
                        p.handCardIds = CDTLJRoomModel.delCardWithArr(p.handCardIds,msg.data.cardIds);
                ...
                msg.type = CDTLJTabelType.XuanLiuShou;
                msg.data = {};
                ...
                msg.type = CDTLJTabelType.DingZhuang;
                msg.data = {};
                ...
                msg.type = CDTLJTabelType.ChangeTuoGuan;
                msg.data = {};
                ...
                msg.type = "YYBS_ZDY";
                msg.data = {};
                msg.data.params = [step.vals[0],step.nextSeat];

                table.remain = 4;
                table.ext[18] = step.vals[0];

                if(table.ext[18] == 2){//找队友
                    table.remain = 12;
                    table.nextSeat = msg.data.params[1];
                }

            }else if(step.action == 11){
                msg.type = CDTLJTabelType.CreateTable;
    ...
    sendTableMsg:function(step){
        ...
        CDTLJRoomModel.init(table);
        SyEventManager.dispatchTableEvent(CDTLJTabelType.CreateTable,table);
    },
    ...
    sendPlayMsg:function(step){
        ...
        if(this.msgArr[step].type == CDTLJTabelType.CreateTable){
            CDTLJRoomModel.init(msgData);
        }
    ...
    sendOverMsg:function(){
        SyEventManager.dispatchTableEvent(CDTLJTabelType.OnOver,this.resultData);
    },
