...
var CDTLJBaseRoomLayer = cc.Layer.extend({
    ...
    initRoomItem:function(){
        this.roomItemBg = new cc.Sprite("res/res_cdtlj/infobg.png");
    ...
    addMenuBtn:function(){
        this.btn_menu = new ccui.Button("res/res_cdtlj/shang.png","res/res_cdtlj/shang.png","res/res_cdtlj/xia.png");
