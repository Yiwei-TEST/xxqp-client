...
var CDTLJTouXiangTipLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        this.btn_agree = new ccui.Button("res/res_cdtlj/tongyi.png","res/res_cdtlj/tongyi.png","");
        ...
        this.btn_refuse = new ccui.Button("res/res_cdtlj/jujue.png","res/res_cdtlj/jujue.png","");
