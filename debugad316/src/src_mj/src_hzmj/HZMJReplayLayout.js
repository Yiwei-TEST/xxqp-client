...
var HZMJReplayLayout = cc.Class.extend({
    ...
    refreshP1:function(data){
        ...
        for(var i=0;i<data.length;i++){
            ...
            }else if(MJReplayModel.wanfa == GameTypeEunmMJ.DZMJ){
                if(data[i].i == ClosingInfoModel.ext[15]){
                    data[i].wang = 1;
                }
            }else if(MJReplayModel.wanfa == GameTypeEunmMJ.ZOUMJ){
                if(data[i].i == ClosingInfoModel.ext[15] || data[i].i == ClosingInfoModel.ext[26]){
                    data[i].wang = 1;
                }
            }
        }
