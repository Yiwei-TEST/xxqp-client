...
var AHMJReplayLayout = cc.Class.extend({
    ...
    refreshP1:function(data){
        ...
        }else if(MJReplayModel.wanfa == GameTypeEunmMJ.KWMJ){
        ...
        for(var i=0;i<data.length;i++){
            if (MJReplayModel.wanfa == GameTypeEunmMJ.AHMJ || MJReplayModel.wanfa == GameTypeEunmMJ.KWMJ){
                if (MJReplayModel.ahmj_wangID && MJReplayModel.ahmj_wangID != -1){
                    ...
                    }else if (MJReplayModel.wanfa == GameTypeEunmMJ.KWMJ && MJReplayModel.intParams[4] == 0 && data[i].t == _wangVo.t && data[i].n == _wangVo.n){
                        data[i].zhengwang = 1;
                    }
                }
            }
        ...
        for(;i<newData.length;i++){
            var card ;
            card = new AHMahjong(MJAI.getDisplayVo(this.direct,place),newData[i]);
