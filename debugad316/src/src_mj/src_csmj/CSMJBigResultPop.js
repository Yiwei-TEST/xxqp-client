...
var CSMJBigResultPop = BasePopup.extend({
    ...
    refreshSingle:function(widget,user){
        ...
        cc.log(" 麻将玩法  MJRoomModel.wanfa = ",MJRoomModel.wanfa);
        cc.log(" 大结结算 ",JSON.stringify(user.actionCount));
        var itemArr = ["大胡次数", "小胡次数", "大胡点炮", "小胡点炮", "大胡接炮", "小胡接炮"];
        var localPosArr = [495, 440, 385, 330, 275, 220];
        ...
        if(MJRoomModel.wanfa == GameTypeEunmMJ.YYMJ){
            ...
            ccui.helper.seekWidgetByName(widget,"Label_zm").setString(tempZM + "");
            ccui.helper.seekWidgetByName(widget,"Label_zm_0").setString(tempJP + "");
            ccui.helper.seekWidgetByName(widget,"Label_zm_1").setString(tempDP + "");
            ccui.helper.seekWidgetByName(widget,"Label_zm_2").setString(zhongniaoCount+"");
        }else{
            ccui.helper.seekWidgetByName(widget,"Label_zm").setString(dhzmCount);
            ccui.helper.seekWidgetByName(widget,"Label_zm_0").setString(xhzmCount);
            ccui.helper.seekWidgetByName(widget,"Label_zm_1").setString(dhdpCount);
            ccui.helper.seekWidgetByName(widget,"Label_zm_2").setString(xhdpCount);
            ccui.helper.seekWidgetByName(widget,"Label_zm_3").setString(dhjpCount);
            ccui.helper.seekWidgetByName(widget,"Label_zm_4").setString(xhjpCount);
        }
        ...
        this.Label_point.y = pointPanel.height/2 + 4;
    ...
    selfRender: function () {
        ...
        //if(MJRoomModel.wanfa == GameTypeEunmMJ.TJMJ || MJRoomModel.wanfa == GameTypeEunmMJ.GDCSMJ){
