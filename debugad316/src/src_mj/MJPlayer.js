...
var MJPlayer = BaseRoomPlayer.extend({
    ...
    ctor:function(vo,root,seq){
        ...
        if(!MJRoomModel.isClubGoldRoom() && (MJRoomModel.wanfa == GameTypeEunmMJ.DHMJ || MJRoomModel.wanfa == GameTypeEunmMJ.BSMJ)){//保山德宏不要比赛分
    ...
    showIcon:function(){
        ...
        this.userIconPop.showIcon(this.iconbg,this._playerVo.icon,null,MJRoomModel.isMoneyRoom());
        return;
