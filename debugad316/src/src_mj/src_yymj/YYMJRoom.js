...
var YYMJRoom = BaseRoom.extend({
    ...
    selfRender:function(){
        ...
        var huBg = "res/res_mj/res_csmj/csmjRoom/img_ting2.png";
        ...
        this.button_wanfa =  new ccui.Button("res/res_mj/res_csmj/csmjRoom/wanfa.png","","");
    ...
    initwanfaImg:function(){
        ...
        if (this.Panel_20.getChildByName("wanfaImg")){
            ...
            var bg = UICtor.cS9Img("res/res_mj/res_csmj/csmjRoom/xiala.png",cc.rect(5,17,117,5),cc.size(320,bgHeigh));
    ...
    showTJMJGang:function(seat){
        ...
        if(acts.length > 0){
            var bg = new cc.Scale9Sprite("res/res_mj/res_csmj/csmjRoom/img_ting1.png");
    ...
    initData:function(){
        ...
        for(var i=0;i<players.length;i++){
            ...
            if(!isContinue){
                ...
                var banker = null;
                cc.log(" 恢复数据！！！ ",JSON.stringify(p.moldCards));
    ...
    updateRoomInfo:function(color){
        ...
        var label = new RichLabel(cc.size(200,40),1);
        label.setLabelString(ele1);
    ...
    displaySelectMahjongs:function(action,resultArray,tip){
        ...
        var scale = 1;
        var bg = new cc.Scale9Sprite("res/res_mj/res_csmj/csmjRoom/img_50.png");
    ...
    refreshButton:function(selfAct){
        ...
        if(selfAct.length>0){
            ...
            var textureMap = {//添加 index 用来排序
                ...
                6:{t:"res/res_mj/res_csmj/csmjRoom/qys.png",v:8,index:11},
                7:{t:"res/res_mj/res_csmj/csmjRoom/bbh.png",v:8,index:11},
                8:{t:"res/res_mj/res_csmj/csmjRoom/yzh.png",v:8,index:11},
                9:{t:"res/res_mj/res_csmj/csmjRoom/llx.png",v:8,index:11},
                10:{t:"res/res_mj/res_csmj/csmjRoom/dsx.png",v:8,index:11},
                11:{t:"res/res_mj/res_csmj/csmjRoom/jtyy.png",v:8,index:11},
                12:{t:"res/res_mj/res_csmj/csmjRoom/jjg.png",v:8,index:11},
                13:{t:"res/res_mj/res_csmj/csmjRoom/st.png",v:8,index:11},
                14:{t:"res/res_mj/res_csmj/csmjRoom/ztsx.png",v:8,index:11},
                15:{t:"res/res_mj/res_csmj/csmjRoom/ztllx.png",v:8,index:11},
