 ...
 */
var TJMJLayout = cc.Class.extend({
    gangPai:[],
    ...
    refreshP3:function(data){
        ...
        switch (this.direct){
            case 1:
                g = 64;
                initVal = 34;//MJRoomModel.renshu ==2? 34 + 360:34+20;
                break;
            case 2:
                g = 46;
                initVal = g;// - 80;
            ...
            case 3:
                g = 64;
                initVal = this.oPanel.width-g-34;//MJRoomModel.renshu ==2?this.oPanel.width-g-530:this.oPanel.width-g-35;
                break;
            case 4:
                g = 46;
