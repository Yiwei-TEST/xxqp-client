...
var HSTHPlayerNode = cc.Node.extend({
    ...
    setYouSpr:function(data){
        ...
        if(data.ext[7] > 0){
            this.youSpr.initWithFile("res/res_hsth/you_" + data.ext[7] + "_icon.png");
    ...
    setTipSpr:function(type){
        if(type == 1){
            ...
            this.tipSpr.initWithFile("res/res_hsth/duzhan.png");
        }else if(type == 2){
            this.tipSpr.setVisible(true);
            this.tipSpr.initWithFile("res/res_hsth/team_icon.png");
        }else{
    ...
    initNode:function(){
        ...
        this.infobg = new cc.Sprite("res/res_hsth/xinxi_di.png");
        this.addChild(this.infobg);

        this.fenbg1 = new cc.Sprite("res/res_hsth/fenshu_di.png");
        this.addChild(this.fenbg1);

        var tip1 = new cc.Sprite("res/res_hsth/zongfen.png");
        tip1.setPosition(tip1.width/2,this.fenbg1.height/2);
        this.fenbg1.addChild(tip1);

        this.fenbg2 = new cc.Sprite("res/res_hsth/fenshu_di.png");
        this.addChild(this.fenbg2);

        var tip2 = new cc.Sprite("res/res_hsth/xifen.png");
        ...
        this.image_coin = new cc.Sprite("res/res_hsth/img_jinbi.png");
        ...
        this.icon_tuoguan = new cc.Sprite("res/res_hsth/tuoguan.png");
        this.addChild(this.icon_tuoguan,2);

        this.icon_ip_same = new cc.Sprite("res/res_hsth/ipsame.png");
        this.icon_ip_same.setScale(0.9);
        this.addChild(this.icon_ip_same,2);

        this.spr_out_line = new cc.Sprite("res/res_hsth/img_zl.png");
        this.addChild(this.spr_out_line,3);

        this.icon_zhunbei = new cc.Sprite("res/res_hsth/zhunbei.png");
        this.addChild(this.icon_zhunbei);

        this.yybg = new cc.Sprite("res/res_hsth/img_yybg.png");
        this.yybg.setAnchorPoint(1,0.5);
        this.yybg.setVisible(false);
        this.addChild(this.yybg);

        this.yyts = new cc.Sprite("res/res_hsth/img_yyts.png");
        ...
        this.warningSpr = new cc.Sprite("res/res_hsth/warning.png");
        this.addChild(this.warningSpr);

        this.tipSpr = new cc.Sprite("res/res_hsth/duzhan.png");
        this.addChild(this.tipSpr,3);

        this.paiBei = new ccui.ImageView("res/res_hsth/paibei.png");
        ...
        this.baoWangBg = new cc.Scale9Sprite("res/res_hsth/jiugonga1.png");
        ...
        this.yaobuqiSpr = new cc.Sprite("res/res_hsth/yaobuqi.png");
