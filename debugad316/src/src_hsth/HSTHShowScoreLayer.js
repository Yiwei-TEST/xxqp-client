...
var HSTHShowScoreLayer = cc.Layer.extend({
    ...
    initLayer:function(){
        ...
        this.layerBg = new cc.Scale9Sprite("res/res_hsth/fenpaiView.png");
        this.layerBg.setPosition(cc.winSize.width/2,cc.winSize.height/2);
        this.addChild(this.layerBg);

        var img = "res/res_hsth/fenpaiTitle.png";
        ...
        var scoreBg = new cc.Sprite("res/res_hsth/FenPaiTxt_di.png");
