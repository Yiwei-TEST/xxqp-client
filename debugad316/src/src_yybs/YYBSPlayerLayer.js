...
var YYBSPlayerNode = cc.Node.extend({
    ...
    initNode:function(){
        ...
        this.icon_tuoguan = new cc.Sprite("res/res_yybs/tuoguan.png");
        this.addChild(this.icon_tuoguan,2);

        this.icon_ip_same = new cc.Sprite("res/res_yybs/ipsame.png");
        this.icon_ip_same.setScale(0.9);
        this.addChild(this.icon_ip_same,2);

        this.spr_out_line = new cc.Sprite("res/res_yybs/img_zl.png");
        ...
        this.yybg = new cc.Sprite("res/res_yybs/img_yybg.png");
        this.yybg.setAnchorPoint(1,0.5);
        this.yybg.setVisible(false);
        this.addChild(this.yybg);

        this.yyts = new cc.Sprite("res/res_yybs/img_yyts.png");
