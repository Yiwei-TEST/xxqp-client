 ...
 */
var ERDDZMenuBtnLayer = cc.Layer.extend({
    isHide:true,
    ctor:function(){
        this._super();
    ...
    initLayer:function(){
        this.layerBg = new cc.Scale9Sprite("res/res_erddz/caidanxiala.png");
